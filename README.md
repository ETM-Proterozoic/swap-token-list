# @etm3/token-list (beta)

[![Tests](https://github.com/Uniswap/token-lists/workflows/Tests/badge.svg)](https://github.com/ETM3/swap-token-list/actions?query=workflow%3ATests)
[![npm](https://img.shields.io/npm/v/@etm3/token-list)](https://unpkg.com/@etm3/token-list@latest/)
...
```typescript
import { TokenList, schema } from '@etm3/token-list'
