...
[![npm](https://img.shields.io/npm/v/@totoroswap/token-list)](https://unpkg.com/@totoroswap/token-list@latest/)
...
```typescript
import { TokenList, schema } from '@totoroswap/token-list'
